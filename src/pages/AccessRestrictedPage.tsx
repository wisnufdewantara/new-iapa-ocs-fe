...
// Sama persis animasi & layout-nya kayak NotFoundPage — cuma teksnya
// diganti "Akses Dibatasi" — dipakai RouteAccessGate begitu role user
// nyoba buka halaman yang menunya nggak dia punya (role_menu_items).
export function AccessRestrictedPage() {
  usePageTitle('Akses Dibatasi')
  ...
  return (
    <div ref={rootRef} className="notfound-page flex min-h-screen flex-col items-center justify-center overflow-hidden">
      ...
      <div className="text-content">
        ...
        <p>Halaman ini bukan untuk peran kamu — si kucing gak ngizinin masuk.</p>
