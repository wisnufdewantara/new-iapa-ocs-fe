// SVG "bongo cat" dipinjam dari sigc-portal (public/under-construction.html
// & resources/views/errors/404.blade.php), dipakai bareng oleh
// ComingSoonPage & NotFoundPage — cuma markup gambar+ID buat di-animate
// GSAP dari komponen pemanggil, styling/warna diatur per halaman (beda
// tema dikit antara under-construction vs 404).
export function BongoCatSvg() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 783.55 354.91" style={{ overflow: 'visible' }}>
      <g id="bongo-cat">
        <g id="question-mark" transform="translate(380, 20) scale(1.5)">
          <path
            d="M20.35,38.61 C15.16,36.99 9.83,34.57 6.51,29.22 C0.88,20.14 8.01,8.35 18.08,3.87 C28.28,-0.67 41.37,1.72 47.59,10.63 C52.64,17.87 50.63,28.38 43.64,34.01 C39.23,37.57 33.69,39.44 30.22,44.35 C28.64,46.59 28.36,49.48 28.36,52.23"
            strokeWidth="6"
            strokeLinecap="round"
          />
          <circle cx="28.36" cy="70" r="6" />
        </g>
        ...
        <g className="table">
          ...
          <line x1="25.3" y1="158.5" x2="783.2" y2="293" fill="none" stroke="#10b981" strokeMiterlimit="10" strokeWidth="4" />
